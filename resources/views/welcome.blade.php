                            ...
                            <article class="game-result">
                                <div class="game-info game-info-creative">
                                    ...
                                    <div class="game-info-main">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <figure style="max-width: 75px;"><img src="images/team-sportland-75x99.png" alt="" width="75" height="99"/></figure>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="game-result-team-name">Sportland</div>
                                                <div class="game-result-team-country">Italy</div>
                                                <div class="time-big" datetime="2020-04-17"><span class="heading-3">Fri 19</span> May 2020</div>
                                        ...
                                        <div class="game-info-team game-info-team-second">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <figure style="max-width: 91px;"><img src="images/team-dream-team-91x91.png" alt="" width="91" height="91"/></figure>
                                                </div>
                                                <div class="col-md-3">
