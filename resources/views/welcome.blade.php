                    ...
                    <div class="rd-navbar-main">
                        <div class="rd-navbar-main-top">
                            ...
                            <ul class="rd-navbar-list">
                                <a class="brand" href="./">
                                    <img class="brand-logo " src="images/logo-soccer-default-95x126.png" alt="" width="95" height="126"/>
                                </a>
                            </ul>
                            <!-- RD Navbar Search-->
                            <div class="rd-navbar-search">
                                <li class="rd-nav-item active"><a class="rd-nav-link" href="index.html">Quem Somos</a>
                                </li>
                                <li class="rd-nav-item"><a class="rd-nav-link">Chances</a>
                                </li>
                                <li class="rd-nav-item"><a class="rd-nav-link">Elenco</a>
                                </li>
                            </div>
                        </div>
                    </div>
